...
MCP stdio server wrapping `@ai-native-solutions/fallprofile-sdk`.

## Install
```bash
claude mcp add fallprofile -- npx -y @ai-native-solutions/fallprofile-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallprofile-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallprofile-mcp -- npx -y @ai-native-solutions/fallprofile-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallprofile-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile-mcp
- **Live URL**: https://sjgant80-hub.github.io/fallprofile-mcp/
- **Source**: https://github.com/sjgant80-hub/fallprofile-mcp
